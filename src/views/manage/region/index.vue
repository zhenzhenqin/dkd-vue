<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="regionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" type="idnex" width="50" align="center" prop="id" />
    ...
    <!-- 查看详情对话框 -->
    <el-dialog title="区域详情" v-model="regionInfo" width="500px" append-to-body>
      <el-form-item label="区域名称" prop="regionName">
...
function getRegionInfo(row) {
  ...
  listNode(loadAllParams).then(response => {
    ...
    nodeList.value.forEach(item => {
      if (item.vmCount == null) {
        item.vmCount = 0;
      }
    });
  });
  regionInfo.value = true;
}
