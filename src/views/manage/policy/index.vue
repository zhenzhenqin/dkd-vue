<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="policyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" type="index" width="60" align="center" prop="policyId" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="getPolicyInfo(scope.row)" v-hasPermi="['manage:policy:list']">策略详情</el-button>
    ...
    <el-dialog title="策略详情" v-model="policyOpen" width="500px" append-to-body>
      ...
      <el-table :data="vmList">
        ...
        <el-table-column label="点位地址" width="250" align="center" prop="addr"/>
        <el-table-column label="设备编号" width="150" align="center" prop="innerCode"/>
      </el-table>
    </el-dialog>
  </div>
</template>
